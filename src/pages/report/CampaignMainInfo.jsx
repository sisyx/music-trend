...
function CampaignMainInfo({campaign, slides, sums = {}, influs = []}) {
    return ( 
        <div className="flex gap-16 md:gap-0 flex-col md:flex-row md:p-5 md:pr-0">
            <div className={`flex flex-col gap-0 rounded-3xl md:shadow-xl md:shadow-gray-500 h-fit`}>
                ...
                <div className={`relative flex md:flex-row flex-col gap-2 bg-white text-gray-600 p-2 md:py-8`} dir="rtl">
                    <span className="md:absolute top-0 right-2 text-sm md:text-base">اسم کمپین: </span>
                    <span className="md:text-2xl font-extrabold">
                        {campaign?.name}
                    </span>
                </div>
                <div className={`relative flex md:flex-row flex-col gap-2 bg-gray-200 text-gray-600 p-2 md:py-8`} dir="rtl">
                    <span className="md:absolute top-0 right-2 text-sm md:text-base">تاریخ شروع: </span>
                    <span className="md:text-2xl font-extrabold">
                        {toShamsi(campaign?.startDate)}
                    </span>
                </div>
                <div className={`relative flex md:flex-row flex-col gap-2 bg-white text-gray-600 p-2 md:py-8`} dir="rtl">
                    <span className="md:absolute top-0 right-2 text-sm md:text-base">مجموع لایک ها</span>
                    <span className="md:text-2xl font-extrabold flex items-center gap-3">
                        <span><FaHeart /></span>
                        <span>
                            {sums?.postLikes} 
                        </span>
            ...
            <div className="flex-1 flex flex-col items-center m-4 mt-0 h-fit bg-white">
